    ...
    <>
      <div className='contactDiv'>
        <div className='fade-in-tl' style={{width: '50%'}}>
          ...
          <br /><br />
          <span className="leadWord "style={{fontSize: 'calc(8px + 2vmin)'}}>Kevin</span>
          </p>
        </div>
        <div className='fade-in' style={{width: '30%'}}>
          <div style={{marginBottom: '3em'}}>
            <h2>By <span className='leadWord'>email</span></h2>
            <h3><Obfuscate email="kwosborne.pt@gmail.com" /></h3>
          </div>
          <div>
            <h2>By <span className='leadWord'>whatsapp</span></h2>
